...
#define STRING_CONFIG_H_AUTHOR "(thisiskeithb, Prusa Mini / SKR Mini E3 V2.0)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Uses separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    // Bondtech Prusa Mini Heatbreak Defaults
    //#define DEFAULT_Kp 13.54
    //#define DEFAULT_Ki 0.98
    //#define DEFAULT_Kd 46.58

    // SKR Mini E3 V2-powered Prusa Mini PID Tuned
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // SKR Mini E3 V2-powered Prusa Mini PID Tuned
  #define DEFAULT_bedKp 36.80
  #define DEFAULT_bedKi 2.72
  #define DEFAULT_bedKd 332.40
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 100, 100, 400, 830 } // Bondtech Prusa Mini Extruder
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -29, -3, -1.35 }
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT 147.4  // X point for Z homing
  #define Z_SAFE_HOMING_Y_POINT 21.1  // Y point for Z homing
#endif
...
//
#define CR10_STOCKDISPLAY  // BigTreeTech TFT35 E3 V3
