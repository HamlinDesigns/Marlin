...
#define STRING_CONFIG_H_AUTHOR "(thisiskeithb, Ender-3 Dual Z BLTouch)" // Who made the changes.
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 142 } // WINSINN Dual Gear Extruder
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -40, -12, -1.325 }
