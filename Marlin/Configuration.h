 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -1.5, -34, -1.5 } // Centered BLTouch mount from https://www.thingiverse.com/thing:4564987
 ...
 */
#define FILAMENT_RUNOUT_SENSOR       // I moved the fillament runout sensor from the TFT to the E0DET pin (P1_26)
