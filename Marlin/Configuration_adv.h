...
//#define BEEP_ON_FEEDRATE_CHANGE
  ...
  #define BINARY_FILE_TRANSFER  // Enabled for firmware updates via MarlinBft in OctoPrint: https://plugins.octoprint.org/plugins/marlinbft/
 ...
 */
  ...
  // Note: this values cannot be calibrated and have to be set manually
    ...
    #define PTC_PROBE_POS  { 127, 106 } // {(X_BED_SIZE / 2), (Y_BED_SIZE / 2)}
...
#define CUSTOM_MENU_MAIN
  ...
  #define MAIN_MENU_ITEM_1_DESC "Z Cal: " PREHEAT_1_LABEL
  #define MAIN_MENU_ITEM_1_GCODE "M117 " MAIN_MENU_ITEM_1_DESC "\nG28\nM107\nM104 S160\nM190 S" STRINGIFY(PREHEAT_1_TEMP_BED) "\nG29\nG1 X2.0 Y-2.0 Z0.60\nM109 S" STRINGIFY(PREHEAT_1_TEMP_HOTEND) Z_CAL_END_SCRIPT "M0 " MAIN_MENU_ITEM_1_DESC " Complete"
  #define MAIN_MENU_ITEM_1_CONFIRM          // Show a confirmation dialog before this action

  #define MAIN_MENU_ITEM_2_DESC "Z Cal: " PREHEAT_2_LABEL
  #define MAIN_MENU_ITEM_2_GCODE "M117 " MAIN_MENU_ITEM_2_DESC "\nG28\nM107\nM104 S160\nM190 S" STRINGIFY(PREHEAT_2_TEMP_BED) "\nG29\nG1 X2.0 Y-2.0 Z0.60\nM109 S" STRINGIFY(PREHEAT_2_TEMP_HOTEND) Z_CAL_END_SCRIPT "M0 " MAIN_MENU_ITEM_2_DESC " Complete"
  #define MAIN_MENU_ITEM_2_CONFIRM

  #define MAIN_MENU_ITEM_3_DESC "Z Cal: " PREHEAT_3_LABEL
  #define MAIN_MENU_ITEM_3_GCODE "M117 " MAIN_MENU_ITEM_3_DESC "\nG28\nM107\nM104 S160\nM190 S" STRINGIFY(PREHEAT_3_TEMP_BED) "\nG29\nG1 X2.0 Y-2.0 Z0.60\nM109 S" STRINGIFY(PREHEAT_3_TEMP_HOTEND) Z_CAL_END_SCRIPT "M0 " MAIN_MENU_ITEM_3_DESC " Complete"
  #define MAIN_MENU_ITEM_3_CONFIRM

  #define MAIN_MENU_ITEM_4_DESC "Z Cal: " PREHEAT_4_LABEL
  #define MAIN_MENU_ITEM_4_GCODE "M117 " MAIN_MENU_ITEM_4_DESC "\nG28\nM107\nM104 S160\nM190 S" STRINGIFY(PREHEAT_4_TEMP_BED) "\nG29\nG1 X2.0 Y-2.0 Z0.60\nM109 S" STRINGIFY(PREHEAT_4_TEMP_HOTEND) Z_CAL_END_SCRIPT "M0 " MAIN_MENU_ITEM_4_DESC " Complete"
  #define MAIN_MENU_ITEM_4_CONFIRM

  #define MAIN_MENU_ITEM_5_DESC "Level X Gantry"
  #define MAIN_MENU_ITEM_5_GCODE "M117 " MAIN_MENU_ITEM_5_DESC "\nG34\nM0 " MAIN_MENU_ITEM_5_DESC " Complete"
