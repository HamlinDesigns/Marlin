 ...
 */
#define USE_CONTROLLER_FAN                // I clippped the JST connectors off the two internals 40mm case fans and attached them to HE1 (P2_04) so they only turn on when needed.
