...
#define FAN_MAX_PWM 160  // Limit max output
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 50*60, 50*60, 6*60, 2*60 } // (mm/min) Feedrates for manual moves along X, Y, Z, E from panel
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_FAST_LOAD_ACCEL    312  // (mm/s^2) Lower acceleration may allow a faster feedrate.
...
#define CUSTOM_MENU_MAIN
  ...
  #define MAIN_MENU_ITEM_3_DESC "Level X Gantry"
  #define MAIN_MENU_ITEM_3_GCODE "M117 " MAIN_MENU_ITEM_3_DESC "\nG34\nM0 " MAIN_MENU_ITEM_3_DESC " Complete"
